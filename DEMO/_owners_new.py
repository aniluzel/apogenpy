import POM_GEN
driver = POM_GEN.Driver('http://localhost:8080/owners/new')
...
def Add_Owner(input=""):
	Add_Owner = POM_GEN.ObjectGen('//button[text()=\'Add Owner\']', driver.driver)
	if not input:
		Add_Owner.object.click()
	else:
		Add_Owner.object.send_keys(input)
